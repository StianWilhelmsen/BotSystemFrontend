    ...
    <div class="register-wrapper">
      ...
      <div class="register-form">
          ...
          <div class="input-wrapper">
            <input type="text" id="firstname" name="firstname" required autocomplete="off" v-model="firstname">
            <label for="firstname">Fornavn</label>
          </div>
          <div class="input-wrapper">
            <input type="text" id="lastname" name="lastname" required autocomplete="off" v-model="lastname">
            <label for="lastname">Etternavn</label>
          </div>
          <div class="input-wrapper">
            <input type="text" id="email" name="email" required autocomplete="off" v-model="email">
